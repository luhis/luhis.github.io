        ...
        <Hero color="light" size="fullheight">
          <Hero.Head>
            <Image.Container square>
              <Img fluid={data.placeholderImage.childImageSharp.fluid} alt="profile picture" />
            </Image.Container>
          ...
          <Hero.Body class="align-start">
            <Container>
              <Menu>
                ...
                <Menu.List>
                  <Menu.List.Item><a>Electronics</a></Menu.List.Item>
                  <Menu.List.Item><a>Grass Autotest racing</a></Menu.List.Item>
                  <Menu.List.Item><a>Ancient History</a></Menu.List.Item>
                </Menu.List>
                <Menu.Label>
                  Social Media
                              </Menu.Label>
                <Menu.List>
                  <Menu.List.Item>
                    <a href="https://www.linkedin.com/in/matthew-mccorry/" className="icon-text">
                      <FaLinkedin />
                      matthew-mccorry
                                    </a>
                  </Menu.List.Item>
