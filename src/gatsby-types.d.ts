...
type BlogQuery = { readonly blog: { readonly posts: ReadonlyArray<{ readonly node: { readonly id: string, readonly sourceInstanceName: string, readonly childMarkdownRemark: { readonly id: string, readonly excerpt: string | null, readonly fields: { readonly slug: string }, readonly frontmatter: { readonly author: string, readonly date: string | null, readonly tags: string, readonly title: string } } | null } }> } };
...
type CVQuery = { readonly file: { readonly childrenMarkdownRemark: ReadonlyArray<{ readonly html: string | null } | null> | null } | null };
