...
type BlogQuery = { readonly blog: { readonly posts: ReadonlyArray<{ readonly excerpt: string | null, readonly id: string, readonly fields: { readonly slug: string }, readonly frontmatter: { readonly date: string | null, readonly title: string, readonly author: string, readonly tags: string } }> } };
